...
Form::FormNotExistException::FormNotExistException() {}
Form::FormNotExistException::~FormNotExistException() throw() {}
...
const char* Form::FormNotExistException::what() const throw() {
	return "\x1B[0;101mThe form does not exist!\033[0m";
}
